...
const Login = () => {
  ...
  return (
    <main className=" bg-gray-200 flex justify-center items-center h-screen ">
      {token ? (
        <section className="bg-yellow-400/50 p-6 rounded-lg grid items-center">
          <h3 className="text-[20px] font-medium text-center p-4capitalize">
            Welcome to your dashboard
          </h3>

          <div className="text-center">
            <i className="bx bx-child text-5xl p-4 hover:bg-yellow-600 duration-150 transition-colors"></i>
          </div>
          ...
          <button
            ...
            className="bg-yellow-400 text-white py-2 mt-3 block rounded-md w-full hover:bg-yellow-800 duration-150 transition-colors "
          >
            LogOut
          </button>
        </section>
        ...
        >
          ...
          <section className="mt-7 bg-yellow-400/50 p-4 rounded-lg grid items-center ">
            <h5 className="text-center p-1 minitablets:text-sm ">Test data</h5>

            <div className="p-1 font-semibold">
              <i className="bx bx-envelope font-medium "></i>
              <span className="minitablets:text-lg"> BrandonyJenn@gmail.com </span>
            </div>

            <div className="p-1 font-semibold">
              <i className="bx bx-lock-alt font-medium "></i>
              <span className="minitablets:text-lg"> jenn24B </span>
            </div>
          </section>
          ...
          <button
            className="bg-yellow-400 text-white mb-5 py-2 block rounded-md w-full mt-5 hover:bg-yellow-500 
          ...
          <span className="font-medium minitablets:text-base ">
            ...
            <NavLink
              className="text-yellow-600 cursor-pointer hover:text-yellow-500 transition-colors pl-3 "
              to="/Loginpersonal"
            >
              Sign Up 
            </NavLink>
