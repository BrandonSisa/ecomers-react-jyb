  ...
  return (
    <>
      <section className="flex gap-2 items-center mt-24 pl-16 ">
        <Link to="/">Home</Link>
        <div className="h-[5px] aspect-square bg-yellow-600 rounded-full"></div>
        <span className="font-bold text-yellow-600"> {productData?.title} </span>
      </section>
      <section className="grid sm:grid-cols-2 gap-5 sm:mt-6 items-center max-w-[1000px] mx-auto">
        ...
        <section className="overflow-hidden relative">
          ...
          right-2 text-2xl text-yellow-600"
          ></i>
          <i
            onClick={nextImage}
        ...
        <section className="">
            ...
            <article>
              ...
              <div className="flex items-center">
                <button
                  ...
                  className="border-[2px] p-3 px-5 hover:bg-yellow-600 hover:text-white transition-colors"
                >
                  -
                </button>
          ...
          <button
            ...
            className={`w-full bg-yellow-500 text-white py-2 rounded-md hover:bg-yellow-400 hover:transition-colors mt-6`}
          >
